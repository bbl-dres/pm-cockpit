...
- **Three View Modes**: Gallery grid, sortable list table, and interactive MapLibre map
...
- **Mapping**: MapLibre GL JS v4.7.1 with CARTO Positron basemap (no API token required)
